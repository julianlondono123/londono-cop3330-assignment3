...
public class Website_Gen {
    public static void main( String[] args ) {
        ...
        create_website(website, js, css, currentPath, author, siteName);
    }
    public static void create_website(File website, char js, char css, String currentPath, String author, String siteName) {
